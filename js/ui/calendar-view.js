...
function goToSpecificDate(dateKey) {
    ...
    // Recarregar visualização de cronogramas com foco nesta data
    showScheduleView('week');

    // Encontrar e ir para o índice correto
    const index = carouselState.schedules.findIndex(s => s.date === dateKey);
    if (index >= 0) {
